...
function inherit(Child, Parent) {
 ...
 var Shader;
 /***************************************************** 
  * File path: ./src/vfold/shader/fragment-color.shader 
  *****************************************************/ 

 /***************************************************** 
  * File path: ./src/vfold/shader/fragment-path.shader 
  *****************************************************/ 

 /***************************************************** 
  * File path: ./src/vfold/shader/fragment-bezier.shader 
  *****************************************************/ 

 /***************************************************** 
  * File path: ./src/vfold/shader/vertex-matrix.shader 
  *****************************************************/ 
